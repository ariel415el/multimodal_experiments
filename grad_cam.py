...
# model, preprocess = clip.load(clip_model, device=device, jit=False, download_root='/mnt/storage_ssd/big_files')
...
image_path = '/mnt/storage_ssd/datasets/imagenette2-160/val/n03394916/ILSVRC2012_val_00025430.JPEG'
